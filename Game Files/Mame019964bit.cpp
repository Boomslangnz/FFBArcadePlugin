...
static int sanfran64hack(int ffsan64hack) {
	switch (ffsan64hack) {
...
void Mame019964bit::FFBLoop(EffectConstants * constants, Helpers * helpers, EffectTriggers * triggers) {
	...
	if (hWnds > NULL)
	{
		...
		UINT8 ff2049564 = helpers->ReadByte(ff2049464 + 0x79C, /* isRelativeOffset */ false); //SanFranRush204964bit
		...
		UINT8 ff2049564ui = helpers->ReadByte(ff2049464ui + 0x79C, /* isRelativeOffset */ false); //SanFranRush204964bitmameUI
	...
	else if (hWnd > NULL)
	{
		...
		int ffsanfranrush64hack = 0;
		{
			INT_PTR ff64 = helpers->ReadIntPtr(0x0C5E4FE8, /* isRelativeOffset*/ true);
			INT_PTR ff164 = helpers->ReadIntPtr(ff64 + 0x48, /* isRelativeOffset*/ false);
			INT_PTR ff264 = helpers->ReadIntPtr(ff164 + 0x48, /* isRelativeOffset*/ false);
			INT_PTR ff364 = helpers->ReadIntPtr(ff264 + 0x668, /* isRelativeOffset*/ false);
			INT_PTR ff464 = helpers->ReadIntPtr(ff364 + 0x90, /* isRelativeOffset*/ false);
			UINT8 ffsan64 = helpers->ReadByte(ff464 + 0x764, /* isRelativeOffset */ false); //SanFranRush64bit
			INT_PTR ff64ui = helpers->ReadIntPtr(0x0C075FB8, /* isRelativeOffset*/ true);
			INT_PTR ff164ui = helpers->ReadIntPtr(ff64ui + 0x1A0, /* isRelativeOffset*/ false);
			INT_PTR ff264ui = helpers->ReadIntPtr(ff164ui + 0x10, /* isRelativeOffset*/ false);
			INT_PTR ff364ui = helpers->ReadIntPtr(ff264ui + 0x8, /* isRelativeOffset*/ false);
			INT_PTR ff464ui = helpers->ReadIntPtr(ff364ui + 0x18, /* isRelativeOffset*/ false);
			UINT8 ffsan64ui = helpers->ReadByte(ff464ui + 0x54, /* isRelativeOffset */ false); //SanFranRush64bit mameui
			INT_PTR ff64hack = helpers->ReadIntPtr(0x0C50CFE8, /* isRelativeOffset*/ true);
			INT_PTR ff164hack = helpers->ReadIntPtr(ff64hack + 0x48, /* isRelativeOffset*/ false);
			INT_PTR ff264hack = helpers->ReadIntPtr(ff164hack + 0x48, /* isRelativeOffset*/ false);
			INT_PTR ff364hack = helpers->ReadIntPtr(ff264hack + 0x48, /* isRelativeOffset*/ false);
			INT_PTR ff464hack = helpers->ReadIntPtr(ff364hack + 0x90, /* isRelativeOffset*/ false);
			UINT8 ffsan64hack = helpers->ReadByte(ff464hack + 0x764, /* isRelativeOffset */ false); //SanFranRush64bithack
			std::string ffs1 = std::to_string(ffsan64);
			std::string ffs2 = std::to_string(ffsan64ui);
			std::string ffs3 = std::to_string(ffsan64hack);
			helpers->log((char *)ffs1.c_str());
			helpers->log("got value: ");
			ffsanfranrush64 = sanfran64(ffsan64);
			ffsanfranrush64ui = sanfran64ui(ffsan64ui);
			ffsanfranrush64hack = sanfran64hack(ffsan64hack);
			...
			if (FFBMode == 0)
			{
				...
				else if ((ffsanfranrush64hack > 112) & (ffsanfranrush64hack < 233))
				{
					helpers->log("moving wheel left");
					double percentForce = (233 - ffsanfranrush64hack) / 119.0;
					double percentLength = 100;
					triggers->LeftRight(0, percentForce, percentLength);
					triggers->Constant(constants->DIRECTION_FROM_RIGHT, percentForce);
				}
				else if ((ffsanfranrush64hack > 0) & (ffsanfranrush64hack < 114))
				{
					helpers->log("moving wheel right");
					double percentForce = (ffsanfranrush64hack) / 112.0;
					double percentLength = 100;
					triggers->LeftRight(percentForce, 0, percentLength);
					triggers->Constant(constants->DIRECTION_FROM_LEFT, percentForce);
				}
	...
	if (hWnd4 > NULL)
	{
		...
		int ffraveui64 = 0;
		{
			...
			UINT8 ffRaw64 = helpers->ReadByte(ffrave644 + 0x42, /* isRelativeOffset */ false); //Rave Racer 64bit
			...
			UINT8 ffRawui64 = helpers->ReadByte(ffraveui644 + 0x42, /* isRelativeOffset */ false); //Rave Racer mameui 64bit
	...
	if (hWnd9 > NULL)
	{
		INT_PTR ffcal164 = helpers->ReadIntPtr(0x0C5E4FE8, /* isRelativeOffset*/ true);
		INT_PTR ffcal264 = helpers->ReadIntPtr(ffcal164 + 0x48, /* isRelativeOffset*/ false);
		INT_PTR ffcal364 = helpers->ReadIntPtr(ffcal264 + 0x48, /* isRelativeOffset*/ false);
		INT_PTR ffcal464 = helpers->ReadIntPtr(ffcal364 + 0x310, /* isRelativeOffset*/ false);
		INT_PTR ffcal564 = helpers->ReadIntPtr(ffcal464 + 0x398, /* isRelativeOffset*/ false);
		UINT8 ffcal664 = helpers->ReadByte(ffcal564 + 0x5AC, /* isRelativeOffset */ false); //CaliforniaSpeed64bit
		INT_PTR ffcal164ui = helpers->ReadIntPtr(0x0C075FB8, /* isRelativeOffset*/ true);
		INT_PTR ffcal264ui = helpers->ReadIntPtr(ffcal164ui + 0x48, /* isRelativeOffset*/ false);
		INT_PTR ffcal364ui = helpers->ReadIntPtr(ffcal264ui + 0x48, /* isRelativeOffset*/ false);
		INT_PTR ffcal464ui = helpers->ReadIntPtr(ffcal364ui + 0x140, /* isRelativeOffset*/ false);
		INT_PTR ffcal564ui = helpers->ReadIntPtr(ffcal464ui + 0x408, /* isRelativeOffset*/ false);
		UINT8 ffcal664ui = helpers->ReadByte(ffcal564ui + 0x5AC, /* isRelativeOffset */ false); //CaliforniaSpeedMameUI64
		helpers->log("got value: ");
	...
	if (hWnd12 > NULL)
	{
		...
		int ffcrusnwldui = 0;
		{
			...
			UINT8 ffcru664 = helpers->ReadByte(ffcru564 + 0x774, /* isRelativeOffset */ false); //CrusnWld64bit
			...
			UINT8 ffcru6ui = helpers->ReadByte(ffcru5ui + 0x774, /* isRelativeOffset */ false); //CrusnWldUI64
	...
	if (hWnd21 > NULL)
	{
		...
		int ffcrusnusaui = 0;
		{
			...
			if (hWnd22 > NULL)
			{
				INT_PTR ffoff164 = helpers->ReadIntPtr(0x0C5E4FE8, /* isRelativeOffset*/ true);
				INT_PTR ffoff264 = helpers->ReadIntPtr(ffoff164 + 0xB8, /* isRelativeOffset*/ false);
				INT_PTR ffoff364 = helpers->ReadIntPtr(ffoff264 + 0x8, /* isRelativeOffset*/ false);
				INT_PTR ffoff464 = helpers->ReadIntPtr(ffoff364 + 0x0, /* isRelativeOffset*/ false);
				INT_PTR ffoff564 = helpers->ReadIntPtr(ffoff464 + 0x0, /* isRelativeOffset*/ false);
				UINT8 ffoff664 = helpers->ReadByte(ffoff564 + 0x54, /* isRelativeOffset */ false); //OffRoadChallenge64bit
				INT_PTR ffoff164UI = helpers->ReadIntPtr(0x0C075FB8, /* isRelativeOffset*/ true);
				INT_PTR ffoff264UI = helpers->ReadIntPtr(ffoff164UI + 0xB8, /* isRelativeOffset*/ false);
				INT_PTR ffoff364UI = helpers->ReadIntPtr(ffoff264UI + 0x8, /* isRelativeOffset*/ false);
				INT_PTR ffoff464UI = helpers->ReadIntPtr(ffoff364UI + 0x40, /* isRelativeOffset*/ false);
				INT_PTR ffoff564UI = helpers->ReadIntPtr(ffoff464UI + 0x0, /* isRelativeOffset*/ false);
				UINT8 ffoff664UI = helpers->ReadByte(ffoff564UI + 0x54, /* isRelativeOffset */ false); //OffRoadChallenge64UI
				helpers->log("got value: ");
